      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link as={Link} to="/students" onClick={() => setExpanded(false)}>الطلاب</Nav.Link>
            <Nav.Link as={Link} to="/courses" onClick={() => setExpanded(false)}>الدروس</Nav.Link>
            <Nav.Link as={Link} to="/products" onClick={() => setExpanded(false)}>المنتجات</Nav.Link>
            <Nav.Link as={Link} to="/news" onClick={() => setExpanded(false)}>الأخبار</Nav.Link>
            ...
            {/* <Nav.Link as={Link} to="/carousel-demo" onClick={() => setExpanded(false)}>عروض الشرائح</Nav.Link> */}
